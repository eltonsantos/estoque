...
@section("conteudo")
    ...
    @if(empty($produtos))
        ...
        <div class="alert alert-warning">Você não tem nenhum produto cadastrado</div>
    ...
    @if(old("nome"))
        <div class="alert alert-success"><strong>O produto {{ old("nome") }} foi adicionado com sucesso!</strong></div>
    @endif
